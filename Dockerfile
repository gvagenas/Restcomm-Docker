...
#Mobicents Restcomm 7.4.0.GA - 7.4.0.746
...
RUN wget -qc https://mobicents.ci.cloudbees.com/view/RestComm/job/RestComm/746/artifact/Mobicents-Restcomm-JBoss-AS7-7.4.0.746.zip -O- | bsdtar -xvf - -C /opt/ && mv /opt/Mobicents-Restcomm-JBoss-AS7-*/ /opt/Mobicents-Restcomm-JBoss-AS7/
